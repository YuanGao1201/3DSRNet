...
# __C.D3_GAN.output_shape = [64, 64, 64]
# __C.D3_GAN.output_shape_nc = 1
__C.D3_GAN.encoder_input_shape = [128, 128]
# __C.D3_GAN.encoder_input_shape = [64, 64]
...
__C.CTGAN.ffl_lambda = 0.
# image gradient difference loss
__C.CTGAN.igdl_lambda = 0.
# transformer
__C.CTGAN.transformer_lambda = 0.
# conformer
__C.CTGAN.conformer_lambda = 0.
# ssim
__C.CTGAN.ssim_lambda = 0.
# psnr
__C.CTGAN.psnr_lambda = 0.
