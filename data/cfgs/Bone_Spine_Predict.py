...
# from projects
from cfgs.util import sparse_df_to_arr
...
class BoneSpine:
    ...
    def __init__(self, bone_data=None, arr_shape=None, spine_width=100, #100
                 rib_diameter=30,#30
                 spine_connected_rib_y_length_thresholds=180, #180
                 through_thresholds=0.6,#0.6
